...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/chaifly/blog-opensource)
[![Use this template](https://img.shields.io/badge/GitHub-Use%20this%20template-111111?logo=github)](https://github.com/chaifly/blog-opensource/generate)
...
- 在线示例：<https://ducaibao.ink/>
- 当前仓库：<https://github.com/chaifly/blog-opensource>
...
```bash
git clone https://github.com/chaifly/blog-opensource.git
cd blog-opensource
npm install
cp .env.example .env.local
npm run dev
